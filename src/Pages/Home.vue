        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            ...
            <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300 ease-in-out">
                    ...
                    <h3 class="mb-2 text-xl text-[#0F364D] font-bold ">Consulting & Strategy</h3>
                    <p class="text-gray-500 dark:text-gray-400">We provide expert consulting services to help you navigate complex challenges and develop effective strategies.</p>
                </div>
                <!-- Card 2 -->
                <div class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300 ease-in-out">
                    <div class="flex justify-center items-center w-12 h-12 mb-4 bg-[#0F364D] rounded-full">
                    ...
                    <h3 class="mb-2 text-xl font-bold ">Design & Development</h3>
                    <p class="text-gray-500 dark:text-gray-400">Our team excels in creating modern, user-friendly designs and developing high-quality applications.</p>
                </div>
                <!-- Card 3 -->
                <div class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300 ease-in-out">
                    <div class="flex justify-center items-center w-12 h-12 mb-4 bg-[#0F364D] rounded-full">
                    ...
                    <h3 class="mb-2 text-xl font-bold ">Product Management</h3>
                ...
                <div class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300 ease-in-out">
                    <div class="flex justify-center items-center w-12 h-12 mb-4 bg-[#0F364D] rounded-full">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16"></path></svg>
                    </div>
                    <h3 class="mb-2 text-xl font-bold ">Digital Marketing</h3>
                    <p class="text-gray-500 dark:text-gray-400">Our digital marketing services help you reach your audience effectively, with data-driven strategies and creative campaigns.</p>
                </div>
                <!-- Card 5 -->
                <div class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300 ease-in-out">
                    <div class="flex justify-center items-center w-12 h-12 mb-4 bg-[#0F364D] rounded-full">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 5l7 7-7 7M5 5l7 7-7 7"></path></svg>
                    </div>
                    <h3 class="mb-2 text-xl font-bold ">Data Analytics</h3>
                    <p class="text-gray-500 dark:text-gray-400">We provide comprehensive data analytics services, offering insights that drive smarter business decisions.</p>
                </div>
                <!-- Card 6 -->
                <div class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300 ease-in-out">
                    <div class="flex justify-center items-center w-12 h-12 mb-4 bg-[#0F364D] rounded-full">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 17l4-4-4-4m0 8v-8"></path></svg>
                    </div>
                    <h3 class="mb-2 text-xl font-bold ">Support & Maintenance</h3>
                    <p class="text-gray-500 dark:text-gray-400">Our support and maintenance services ensure your systems remain up-to-date and run smoothly, with minimal downtime.</p>
                </div>
            </div>
        </div>
    </section>
